  ...
  return (
    <div className="h-screen bg-gray-100">
      ...
      >
       ...
       <h2 className="md:text-4xl text-2xl font-semibold mb-4">India's best Doctor Consultation at Home</h2>
        <h1 className="md:text-5xl text-3xl font-bold mb-6">Expert Doctor Visit At Home</h1>
