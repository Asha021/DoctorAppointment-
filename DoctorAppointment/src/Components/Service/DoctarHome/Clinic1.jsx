    ...
    return (
        <div className="h-screen bg-gray-100">
          ...
          >
           ...
           <h2 className="text-3xl font-cutumFont mb-4">India's best online appointment scheduling platform</h2>
            <h1 className="text-5xl font-bold mb-6">Book An Clinic Appointment</h1>
